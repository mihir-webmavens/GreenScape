                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="card mb-4 product-wap rounded-0">
                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-unstyled d-flex align-items-center justify-content-between mb-1">
                                    <li> <a href="{{route('shopSingleShow',$product->id)}}" class="pt-1 mb-0">{{$product->price}}</a></li>
                                    <li>
                                        <a class="btn btn-success text-white mt-2" href="{{ route('shopSingleShow', [$product->id]) }}">
